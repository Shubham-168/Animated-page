        ...
        <div className="w-full flex flex-row items-center justify-evenly pt-10">
          <div>
            <img
              ...
              src="https://raw.githubusercontent.com/MarkoWebDev/React-AxeL-Site/7e953179619276e65d0ec8a32413d7498bf2363e/src/assets/images/google-play.svg"
              alt="googleApp"
            ></img>
          </div>
          <div>
            <img
              className="h-12 cursor-pointer"
              src="https://raw.githubusercontent.com/MarkoWebDev/React-AxeL-Site/7e953179619276e65d0ec8a32413d7498bf2363e/src/assets/images/apple-store.svg"
              alt="googleApp"
            ></img>
          </div>
        </div>
                    ...
                    {starList.map(index => {
                      return (
                        <div key={index}>
                          {item.id === '1' ? (
                            <img 
                            src="https://raw.githubusercontent.com/MarkoWebDev/React-AxeL-Site/7e953179619276e65d0ec8a32413d7498bf2363e/src/assets/images/starWhite.svg" 
                            alt="star"></img>
                          ) : (
                            <img 
                            src="https://raw.githubusercontent.com/MarkoWebDev/React-AxeL-Site/7e953179619276e65d0ec8a32413d7498bf2363e/src/assets/images/star.svg" 
                            alt="star"></img>
                          )}
                        </div>
                      )
